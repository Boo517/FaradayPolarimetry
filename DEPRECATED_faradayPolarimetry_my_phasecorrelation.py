# -*- coding: utf-8 -*-
"""
NOTE: This program uses the phase correlation method in phaseCorrelation.py,
which accounts for translation only, ignoring angle and scale.
Use faradayPolarimetry instead for angle and scale, using imreg_dft module
"""
